...
import { publicSecurityHeaders, readShareCookie, resolveShoppingShare, togglePublicShoppingItem } from "../../src/sharing/shopping-share";
...
export async function action({ request, params, context }: Route.ActionArgs) {
  ...
  const updated = await togglePublicShoppingItem(env.DB, share, params.itemId, body.checked);
