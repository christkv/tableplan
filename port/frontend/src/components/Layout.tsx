import { CalendarDays, ChefHat, Heart, ListChecks, LogOut, Search, Settings } from "lucide-react";
...
export function ProtectedLayout() {
  ...
  if (session === undefined) return <main className="shared-loading"><div><span className="brand-mark"><ChefHat size={20} /></span><h1>Opening Tableplan</h1><p>Loading your household.</p></div></main>;
  ...
  return <div className="app-frame">
    <aside className="sidebar">
      <NavLink to="/recipes" className="brand" aria-label="Tableplan recipes"><span className="brand-mark"><ChefHat size={20} /></span><span>Tableplan</span></NavLink>
